...
my $str = "java -Xmx3500M -jar /$path/../../../gio_applications/searchgui/SearchGUI/resources/MS-GF+/MSGFPlus.jar -s /$path/tmp_$id.$type -d $fasta_file -o /$path/tmp_$id.mzid -mod /$path/tmp_$id.mods $args";
#print "$str\n";
system($str);
